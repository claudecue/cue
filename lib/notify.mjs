...
function buildDarwin({ title, body, subtitle, sessionId, sound, hasTerminalNotifier, activate }) {
  if (hasTerminalNotifier) {
    ...
    // Bring this session's terminal/editor app to the front when clicked.
